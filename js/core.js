...
const APP_VERSION = '4.85-recebimentos-rico';
  ...
  ` : `
    <div style="background:white;border-radius:14px;padding:40px;max-width:420px;width:100%;box-shadow:0 20px 60px rgba(0,0,0,.3);">
      <div style="text-align:center;margin-bottom:20px;">
        ...
        <div style="font-family:'JetBrains Mono',monospace;font-size:10px;color:#666;letter-spacing:.2em;text-transform:uppercase;margin-top:8px;">Inteligência Comercial</div>
      </div>
